...
df_dummy_RL <- readr::read_csv(here("Data", "DummyData_RL", "DummyData_RL_Random_trialN200_1Op0.7_2Op0.3_agentN200_20210707181150", "RL_trial.csv"))


df_est_params <- readr::read_csv(here("Data", "Models_Results", "basic_RL", "fit04", "estimated_parameter", "est_parameter.csv")) %>% 
  dplyr::rename(
    ID = p_index
  ) %>% 
  dplyr::filter(para %in% c("alpha", "beta")) %>% 
